...
class MainActivity : AppCompatActivity() {
    ...
    // Object for when changing orientation
    companion object {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //This is for debugging to find out why the score would reset on orientation change
        Log.d(TAG, "onCreate called. Score is: $score")
        // connect views to variables
        gameScoreTextView = findViewById(R.id.game_score_text_view)
        timeLeftTextView = findViewById(R.id.time_left_text_view)
        tapMeButton = findViewById(R.id.tap_me_button)
        //This calls the animation for when the button is clicked.
        ...
        //when orientation changes, if a game is in progress, resets screen with correct info.
